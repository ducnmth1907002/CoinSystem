namespace Coin.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CoinDbContext>
    {
        ...
        protected override void Seed(CoinDbContext context)
        {
            ...
            context.News.AddOrUpdate(new News()
            {
                ...
                Thumbnail = "https://www.vietnam-ustrade.org/wp-content/uploads/2020/04/Litecoin-LTC.jpg",
            ...
            context.News.AddOrUpdate(new News()
            {
                ...
                Thumbnail= "https://timebit.news/wp-content/uploads/2021/02/ethereum-price-eth-investors-gID_1-1.jpg",
            ...
            context.News.AddOrUpdate(new News()
            {
                ...
                Thumbnail = "https://i.pinimg.com/originals/2c/19/8d/2c198d34463b2f0b5b89c8fa065dbc08.jpg",
            ...
            context.News.AddOrUpdate(new News()
            {
                ...
                Thumbnail = "https://www.corporatecomplianceinsights.com/wp-content/uploads/2018/07/cryptocurrency.jpg",
            ...
            context.News.AddOrUpdate(new News()
            {
                ...
                Thumbnail = "https://tapchibitcoin.io/wp-content/uploads/2021/03/dex.png",
            ...
            context.News.AddOrUpdate(new News()
            {
                ...
                Thumbnail = "https://cms.qz.com/wp-content/uploads/2017/05/moneygram-ant-financial.jpg?quality=75&strip=all&w=1600&h=900&crop=1",
            ...
            context.News.AddOrUpdate(new News()
            {
                ...
                Thumbnail = "https://www.smartenergydecisions.com/upload/images/company_images/goldman-sachs-logo.jpg",
            ...
            context.News.AddOrUpdate(new News()
            {
                ...
                Thumbnail = "https://blockonomi-9fcd.kxcdn.com/wp-content/uploads/2018/06/bittrex-review.jpg",
            ...
            context.News.AddOrUpdate(new News()
            {
                ...
                Thumbnail = "https://blogtienao.com/wp-content/uploads/2021/03/so-luong-btc-duoc-giu-tren-cac-san-giao-dich-da-giam-20-trong-12-thang-2.jpg",
